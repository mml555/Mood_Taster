...
-- Resolve username → email for login (returns email only to authenticated service callers via RPC)
-- Used by the app server with the user's password still verified by Auth.
