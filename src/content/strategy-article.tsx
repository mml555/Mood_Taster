  ...
  return (
    <article className="doc-body">
      <section id="purpose" aria-labelledby="purpose-title">
        <h2 id="purpose-title">1. Document purpose</h2>
        <p>
        ...
        <p>
          ...
          <strong>mobile-first web product</strong>.
        </p>
        <p>Mood Taster is not initially:</p>
        <ul>
          <li>a social network</li>
          <li>a restaurant marketplace</li>
        ...
        <p>
          ...
          hungry but do not know what they want.
        </p>
      </section>

      <section id="thesis" aria-labelledby="thesis-title">
        <h2 id="thesis-title">2. Business thesis</h2>
        <p>Mood Taster sits between hunger and search.</p>
        <p>Current behavior often looks like:</p>
        <p>
          <strong>
            Hungry → Guess what I want → Search → Scroll → Compare → Decide
          </strong>
        </p>
        <p>Mood Taster changes that to:</p>
        <p>
          <strong>
            Hungry → Mood Taster understands the craving → Specific
        ...
        <p>
          ...
          Taster may understand desired flavor, texture, hunger level, budget,
          occasion, atmosphere, cuisine openness, dietary restrictions, comfort
      ...
      <section id="positioning" aria-labelledby="positioning-title">
        <h2 id="positioning-title">3. Commercial positioning</h2>
        <ul>
          <li>
      ...
      <section id="north-star" aria-labelledby="north-star-title">
        ...
        <p>
          Do not optimize primarily for page views, time on site, ad
          impressions, questions answered, or restaurants shown. Mood Taster
          creates value by making a good decision quickly.
        </p>
      </section>
      ...
      <section id="market" aria-labelledby="market-title">
        ...
        <p>
          Supporting line: Answer a few weirdly specific questions. Get one food
      ...
      <section id="phases" aria-labelledby="phases-title">
        ...
        <p>
          ...
          restaurant employees, universities, Jewish community groups, and local
          food creators. Validate accuracy, confusion, completion, repeated
          recs, feedback language, and natural reactions. Not a public launch.
        </p>
        <h3>Phase 1: Miami launch</h3>
        <p>
          1,000–5,000 local users. Message:{" "}
          <em>Miami, stop arguing about where to eat.</em> Primary flow: Go Out.
          Goals: coverage, repeat sessions, sharing, creators, restaurant
          relationships, local press.
        </p>
        <h3>Phase 2: Taste DNA launch</h3>
        <p>
      ...
      <section id="acquisition" aria-labelledby="acquisition-title">
        ...
        <p>
          Preferred loop: complete session → surprisingly accurate result →
          share → friend opens → friend starts immediately → result → save Taste
          DNA → repeat. Do not make users share generic referral codes before
          receiving value.
        </p>
        ...
        <p>
          ...
          one Taste DNA insight, sharing. After one session: DNA begins, flavor
          scores, history preview, XP, account-save. After three rated sessions:
          fuller DNA, top flavors, first quest, passport basics. After five
          successful sessions: underexplored flavor, deeper explanation,
          personalized challenge. Cuisine exploration unlocks stamps and
          exploration badges.
        </p>
        ...
        <p>
          ...
          recommendation into a tiny monthly quota.
        </p>
        <p>
      ...
      <section id="media" aria-labelledby="media-title">
        ...
        <p>
          ...
          demos, taste tests, food personality, local Miami stories, and
      ...
      <section id="retention" aria-labelledby="retention-title">
        ...
        <p>
          ...
          Recaps. Web-first: bookmarks, Add to Home Screen after repeat use,
          email recaps, SMS only with opt-in, careful browser notifications
          later. Never request notifications on first visit.
        </p>
        <p>
