...
export const RECIPES: Record<string, Recipe> = {
  ...
  "butter-chicken": {
      ...
      ingredients: [
        ...
        "2 tbsp butter",
        "Salt",
        "Cooked rice and naan, to serve",
      ],
      steps: [
        "Toss chicken with yogurt, 1 tbsp garam masala, and salt. Rest 15 minutes.",
        "Sear chicken in butter until browned. Set aside.",
        "Soften onion, garlic, and ginger. Add tomato sauce and remaining garam masala. Simmer 10 minutes.",
        "Stir in cream and chicken. Simmer until thick and cooked through.",
  ...
  "vegetable-samosas": {
      ...
      ingredients: [
        ...
        "Salt",
        "12 square spring roll wrappers or samosa dough",
        "Oil for frying",
        "Mint chutney, to serve",
      ],
      steps: [
        "Warm a little oil. Toast cumin. Stir in peas, spices, and mashed potato. Cool.",
        "Cut wrappers into strips. Fold into cones. Fill with potato mix. Seal edges with water.",
        "Fry in hot oil until deep golden. Drain.",
  ...
  "chicken-souvlaki": {
      ...
      timeMinutes: 35,
      ingredients: [
        "1.5 lb chicken breast or thigh, cubed",
        "3 tbsp olive oil",
        "2 tbsp lemon juice",
        ...
        "Salt and pepper",
        "Pita bread",
        "Tzatziki, tomato, onion, to serve",
      ],
      steps: [
        "Mix oil, lemon, garlic, oregano, salt, and pepper. Toss with chicken. Rest 15 minutes.",
        "Thread chicken onto skewers.",
        "Grill or broil until cooked through and lightly charred.",
        "Warm pita. Serve with tzatziki, tomato, and onion.",
      ],
    },
  "greek-salad": {
      servings: 2,
      ...
      steps: [
        ...
        "Top with feta.",
        "Drizzle oil and vinegar. Sprinkle oregano and salt. Toss gently. Serve cold.",
      ],
    },
  "doro-wat": {
      servings: 4,
      timeMinutes: 75,
      ingredients: [
        "2 lb chicken pieces (thighs and drumsticks)",
      ...
      steps: [
        "Cook onions in a dry pan until soft and browned, about 20 minutes. Add butter.",
        "Stir in berbere and tomato paste. Cook 2 minutes.",
        "Add chicken and a splash of water. Cover and simmer until tender, about 40 minutes.",
        "Add eggs for the last 10 minutes. Season with salt.",
  ...
  "misir-wat": {
      ...
      steps: [
        ...
        "Add berbere and tomato paste. Stir 1 minute.",
        "Add lentils and water. Simmer until thick and soft, about 25 minutes.",
